...
void logout()
{
    ...
    char temp[100], name[90], password[90], email[90], na[90], va[90], em[90];
...
void Delete(int choice)
{
    ...
    int idt, d;
    char Delete[100], temp[100], na[90], va[90], em[90];
    printf("\n\t\t Please! Enter Your Valid Email Address To Delete Your Informaton \n\n\t\t");
    scanf("%s", &Delete);
    FILE *fptr;
    FILE *fp;
    fp = fopen("nuser.txt", "w");
